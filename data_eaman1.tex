...
online community, \url{bitcointalk.org}.  Our data consists of all the posts that were
...
\caption{The first post of a thread announcing the release of Auroracoin for the first time in \url{bitcointalk.org}, at 20 replies per page, at this point it had received well over 5000 replies.}
\label{aurora_thread}
\end{figure}
