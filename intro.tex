...
The majority of these coins have no posible valuable future in the long term, and their markets would appear to be driven largely by speculation.
...
As such, price and volume data from these exchanges is freely available and widely aggregated\footnote{ these are hoever largely unregulated, oftenanonimous, and there is no way to account how much of reported volumes are manipulation attempts, the existance of attempts at arbitrage between them places some bounds on how blatantly the data can be manipulated for prices, but volumes are imposible to asses. }, and the source code to all of them being public is the norm%\footnote{cargo cult CS being derigour in the comunity}.
This makes c
