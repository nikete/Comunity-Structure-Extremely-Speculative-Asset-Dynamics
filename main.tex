\documentclass{acm_proc_article-_p}% http://www.acm.org/sigs/publications/acm_proc_article-sp.cls/view
...
\newcommand\myfigure{%
  \makebox[0pt]{\includegraphics[width=\linewidth]{volume_centrality}} \\[\normalbaselineskip]
...
\begin{figure}
  \includegraphics[width=\linewidth,height=2\baselineskip]{volu}
  \caption{A figure}
\end{figure}
